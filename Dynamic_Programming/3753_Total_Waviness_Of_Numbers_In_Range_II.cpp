...
Approach:
1. Use Digit DP to count waviness efficiently.
2. Process digits from left to right.
3. Track:
   - Previous digit
   - Second previous digit
   - Started state
   - Tight state
4. Count peaks and valleys while building numbers.
5. Calculate answer in range using:
   solve(num2) - solve(num1 - 1)

Time Complexity: O(D * States * 10)

Space Complexity: O(D * States)
*/
